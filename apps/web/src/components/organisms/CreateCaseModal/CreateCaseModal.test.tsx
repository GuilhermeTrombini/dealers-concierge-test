...
describe('CreateCaseModal', () => {
  ...
  it('renders when isOpen is true', () => {
    ...
    expect(
      screen.getByPlaceholderText('Enter case description')
    ).toBeInTheDocument();
  });
  ...
  it('submits form with correct data', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('Enter case title'), {
      target: { value: 'Test Case' },
    });
    fireEvent.change(screen.getByPlaceholderText('Enter case description'), {
      target: { value: 'Test Description' },
    });
    fireEvent.change(screen.getByDisplayValue('2 - Normal'), {
      target: { value: '3' },
    });
