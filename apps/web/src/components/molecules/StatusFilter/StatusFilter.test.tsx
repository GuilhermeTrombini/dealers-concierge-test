...
describe('StatusFilter', () => {
  it('renders all status options', () => {
    ...
    render(<StatusFilter selectedStatus="ALL" onStatusChange={handleStatusChange} />)
  ...
  it('highlights the selected status', () => {
    const handleStatusChange = vi.fn()
    render(<StatusFilter selectedStatus="IN_PROGRESS" onStatusChange={handleStatusChange} />)
