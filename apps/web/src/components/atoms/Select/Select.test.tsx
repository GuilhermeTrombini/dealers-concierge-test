...
describe('Select', () => {
  ...
  it('is required when required prop is true', () => {
    const handleChange = vi.fn()
    render(<Select value="" onChange={handleChange} options={mockOptions} required />)
  ...
  it('applies custom className', () => {
    const handleChange = vi.fn()
    render(<Select value="" onChange={handleChange} options={mockOptions} className="custom-class" />)
